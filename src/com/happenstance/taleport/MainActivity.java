...
public class MainActivity extends Activity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		menu.findItem(R.id.version).setVisible(!drawerOpen);
		menu.findItem(R.id.about).setVisible(!drawerOpen);
		// menu.findItem(R.id.seeBookmarks).setVisible(!drawerOpen);
		// menu.findItem(R.id.bookmark).setVisible(!drawerOpen);
		menu.findItem(R.id.aboutDev).setVisible(!drawerOpen);
		menu.findItem(R.id.social).setVisible(!drawerOpen);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.refresh:
			...
			((PlanetFragment) fragment).setUrl(1);
			return true;
		case R.id.about:
			Intent a = new Intent("com.happenstance.taleport.About");
			startActivity(a);
			return true;
			/*
			 * case R.id.seeBookmarks: Intent ab = new
			 * Intent("com.happenstance.taleport.SeeBookmarks");
			 * startActivity(ab); return true;
			 */
		case R.id.social:
			Intent b = new Intent("com.happenstance.taleport.SocialMedia");
			startActivity(b);
			return true;
		case R.id.version:
			Intent c = new Intent("com.happenstance.taleport.Version");
			startActivity(c);
			return true;
			/*
			 * case R.id.bookmark: Intent e = new
			 * Intent("com.happenstance.taleport.Bookmark"); startActivity(e);
			 * return true;
			 */
		case R.id.aboutDev:
			Intent d = new Intent("com.happenstance.taleport.AboutDeveloper");
			startActivity(d);
			return true;
		default:
	...
	public static class PlanetFragment extends Fragment {
		...
		public void setUrl(int a) {
			...
			switch (i) {
			case 0:
				webView.loadUrl("https://taleportmagazine.com/");
				break;
			case 1:
				webView.loadUrl("https://taleportmagazine.com/category/travel/");
				break;
			case 2:
				webView.loadUrl("https://taleportmagazine.com/category/profiles/");
				break;
			case 3:
				webView.loadUrl("https://taleportmagazine.com/category/history/");
				break;
			case 4:
				webView.loadUrl("https://taleportmagazine.com/category/culture/");
				break;
			case 5:
				webView.loadUrl("https://taleportmagazine.com/category/issues/");
				break;
			case 6:
				webView.loadUrl("https://taleportmagazine.com/category/initiatives/");
				break;
			case 7:
				webView.loadUrl("https://taleportmagazine.com/photo-essays/");
				break;
			case 8:
				webView.loadUrl("https://taleportmagazine.com/category/satire/");
				break;
			case 9:
				webView.loadUrl("https://taleportmagazine.com/category/discussion/");
				break;
			case 10:
				webView.loadUrl("https://taleportmagazine.com/category/blog/");
				break;
			case 11:
				webView.loadUrl("https://taleportmagazine.com/submissions/");
				break;
			case 12:
				webView.loadUrl("https://taleportmagazine.com/our-team/");
				break;
			case 13:
				webView.loadUrl("https://docs.google.com/forms/d/1oVxo3Q9A3gxn_WwHaHZcfRluJP2K_Ux4I-30fA68QdU/viewform");
				break;
			case 14:
				webView.loadUrl("https://taleportmagazine.com/contact-us/");
				break;
			}
		}
	}
